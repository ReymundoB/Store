...
class Cart(models.Model):
    #uno a muchos, los usuarios no autenticados pueden tener su carrito
    ...
    def products_related(self):#funciona como un join
        return self.cartproducts_set.select_related('product')

class CartProductsManage(models.Manager):
...
def set_cart_id(sender, instance, *args, **kwargs):
    if not instance.cart_id:
        instance.cart_id = str(uuid.uuid4()) #generamos un id unico al carrito de compras
